            ...
            <div class="container-fluid">
                ...
                <section id="main-content">
                                            ...
                                            $conn = mysqli_connect("localhost", "root", "", "anonymous");
                                              ...
                                              if ($result->num_rows > 0) {
                                               ...
                                               while($row = $result->fetch_assoc()) {
                                                echo "<tbody><tr><th scope='row'>".$count++."</th><td>" . $row['feedback'] . "</td><td>".$row['date']."</td><td><span class='badge badge-primary'>".$row['status']."</span></td><td>EDit</td></tr></tbody>";
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer">
                                <p>2018 © Admin Pannel Board. - <a href="#">Expeditors.com</a></p>
                            </div>
                        </div>
                    </div>
                </section>
